...
public class Shooter extends RobotComponent {
    ...
    public Shooter(HardwareMap hardwareMap, MainRobot inputRobot) {
        ...
        shooterWheelL.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        shooterWheelR.setMode(DcMotor.RunMode.RUN_USING_ENCODER);

        shooterWheelR.setDirection(DcMotor.Direction.REVERSE);
    }
